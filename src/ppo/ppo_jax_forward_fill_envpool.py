    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _env_step(runner_state, unused):
                (
                    train_state, env_state, episode_stats, last_obsff, last_done, hstate, rng
                ) = runner_state
                ...
                obsffv = jnp.where(done[..., None, None, None], obsv, obsffv)

                transition = Transition(
                    done, action, value, reward, log_prob, last_obsff, info
                )
                runner_state = (train_state, env_state, episode_stats, obsffv, done, hstate, rng)
...
def make_agent_evaluation(config):
    ...
    def agent_eval(params):
        def _env_step(runner_state, unused):
            params, env_state, episode_stats, last_obsff, last_done, hstate, rng = runner_state
            ...
            runner_state = (params, env_state, episode_stats, obsffv, done, hstate, rng)
            return runner_state, transition
